...
//function wrapper for pnorm
// [[Rcpp::export]]
double Pnorm(double mean, double std) {
  return (R::pnorm(1, mean, std));
}
...
// [[Rcpp::export]]
List balm(NumericVector d_obs, NumericMatrix n_obs, int type, bool random=true,
                     int side =1,int pn = 1,
